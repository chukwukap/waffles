...
const InviteFriendsButton = ({ onInvite }: { onInvite: () => void }) => {
    return (
        < div
            className="relative flex items-center justify-between cursor-pointer group transition-all duration-300 ease-out hover:-translate-y-0.5 active:scale-[0.98] hover:shadow-[0_8px_24px_rgba(255,201,49,0.25)]"
            onClick={onInvite}
            style={{
                width: '361px',
                height: '74px',
                ...
                backgroundImage: 'linear-gradient(189.66deg, rgba(0, 0, 0, 0) -6.71%, rgba(0, 0, 0, 0.3) 92.73%)',
        ...
        >
            ...
            < div className="flex flex-col justify-center h-full gap-1 transition-opacity duration-300 group-hover:opacity-100 opacity-95" >
                ...
                >
                    Earn 10% bonus points by inviting friends
                </p>
            </div >
