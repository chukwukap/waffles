...
export function NextGameCard({
    ...
    const countdownDisplay = `${formatPart(hours)}H ${formatPart(minutes)}M ${formatPart(seconds)}S`;
    ...
    return (
        <>
            ...
            >
                ...
                >
                    {/* Spots */}
                    <div className="flex flex-col items-center" style={{ gap: "clamp(2px, 0.5vh, 4px)" }}>
                        <Image
                ...
                {isLive && (
                    <div className="relative flex items-center justify-center gap-2 z-10 shrink-0 py-2">
                        ...
                        <span className="font-body text-red-500 text-lg uppercase">LIVE NOW</span>
                    </div>
                )}
                ...
                >
                    {spotsTaken > 0 ? (
                        ...
                        <span
                            className="font-display"
                            style={{ fontSize: "clamp(11px, 1.6vh, 14px)", color: "#99A0AE", opacity: 0.6 }}
                        >
