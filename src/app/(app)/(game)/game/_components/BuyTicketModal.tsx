  ...
  return (
    <>
      ...
      >
        ...
        <span
          className="font-body"
          style={{ fontSize: "clamp(18px, 4vw, 22px)", color: "#14B985" }}
        >
          ${potentialPayout}
        </span>
      </div>
...
function SuccessContent({
  ...
  return (
    <>
      ...
      >
        ...
        <div className="flex items-center gap-2.5 mb-4">
          ...
          <div>
            <p
              className="font-body text-white"
              style={{ fontSize: "clamp(18px, 4vw, 23px)", lineHeight: "130%" }}
            >
        ...
        <div className="flex items-center gap-3">
          ...
          <div className="flex items-center gap-2">
            ...
            <div>
              ...
              <p className="font-body text-white text-[17px]">
      ...
      <div
        className="flex w-full max-w-[361px] gap-3"
        style={{ height: "45px" }}
      >
        {/* Set Reminder */}
        <button
