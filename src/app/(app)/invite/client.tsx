...
import { useEffect, useState, useRef, useCallback, startTransition, useActionState } from "react";
...
import { validateReferralAction, type ValidateReferralResult } from "@/actions/invite";
...
export default function InvitePageClient() {
  ...
  useEffect(() => {
    if (initialCode && fid && initialCode.length === 6 && !hasAutoValidatedRef.current) {
